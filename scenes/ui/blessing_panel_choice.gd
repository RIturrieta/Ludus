...
func loadBlessing(ability_name: String, character_name: String = ""):
	blessing_name = ability_name
	var path = "res://scenes/abilities/" + character_name + "/" + ability_name + "/" + ability_name + ".tscn"
	...
	skill_icon.texture = ability.Icon
	name_label.text = ability.Name
	if ability.cooldown > 0:
		cooldown_label.text = "Cooldown: " + str(ability.cooldown) + "s"
	else:
